...
23 scenario(s), compiled from the documents an author wrote. Serve this directory and open `index.html`; a browser will not instantiate a module from a `file://` URL.
